            ...
            <div className='p-5 md:p-0'>
                <div className='shadow-lg'>
                     <div className='shadow-2xl rounded-md text-center p-6 md:w-[430px]'>
                        ...
                        <div>
                            <p className='text-center text-base mt-3 md:text-lg ml-8'><span className='text-black opacity-60'>Don't have an account?</span> <Link to='/signup' className='text-blue-500 hover:underline'>Register here</Link></p>
                        </div>
                    </div>
                </div>
            </div>
